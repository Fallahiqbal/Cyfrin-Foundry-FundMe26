...
# Deploy Alchemy Sepolia using wallet list
# 1. import wallet
make-wallet-first: cast wallet import firstKey --interactive
make-wallet-second: cast wallet import secondKey --interactive

# 2. deploy
deploy-sepolia-wallet:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account tesnetKey --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
